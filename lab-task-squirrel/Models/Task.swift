    ...
    static var mockedTasks: [Task] {
        return [
            Task(title: "Your favorite local restaurant",
                 description: "Where do you go to eat your favorite food?"),
            Task(title: "Your favorite local cafe",
                 description: "Where do you go to drink the best brewed coffee?"),
            Task(title: "Your go-to brunch place",
                 description: "Where do you go to have the best bottomless mimosas?"),
